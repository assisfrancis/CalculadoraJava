...
public class App extends JFrame implements ActionListener {
        ...
        JButton    bt_mc,bt_mr,bt_ms,bt_mMais,bt_mMenos,bt_seta,bt_ce,bt_c,bt_maisMenos,bt_raiz;
        JButton    bt_7,bt_8,bt_9,bt_div,bt_perc,bt_4,bt_5,bt_6,bt_mult,bt_umx;
        JButton    bt_1,bt_2,bt_3,bt_sub,bt_zero,bt_virgula,bt_adicao,bt_igual;
        JMenuBar   barra_menu;
     ...
     //  Calcular obj_res = new Calcular();
        ...
        {	
            ...
            bt_mc       .setBounds(10,70,55,30);   bt_mc.addActionListener(this);	 
            bt_mr       .setBounds(65,70,55,30);   bt_mr.addActionListener(this);	 
            bt_ms       .setBounds(120,70,55,30);  bt_ms.addActionListener(this);	 
            bt_mMais    .setBounds(175,70,55,30);  bt_mMais.addActionListener(this);	 
            bt_mMenos   .setBounds(230,70,55,30);  bt_mMenos.addActionListener(this);	 
            bt_seta     .setBounds(10,100,55,30);  bt_seta.addActionListener(this);	 
            bt_ce       .setBounds(65,100,55,30);  bt_ce.addActionListener(this);	 
            bt_c        .setBounds(120,100,55,30); bt_c.addActionListener(this);	 
            bt_maisMenos.setBounds(175,100,55,30);
            bt_maisMenos.addActionListener(this);	 
            bt_raiz     .setBounds(230,100,55,30); bt_raiz.addActionListener(this);	 
            bt_7        .setBounds(10,130,55,30);  bt_7.addActionListener(this);	 
            bt_8        .setBounds(65,130,55,30);  bt_8.addActionListener(this);	 
            bt_9        .setBounds(120,130,55,30); bt_9.addActionListener(this);	 
            bt_div      .setBounds(175,130,55,30); bt_div.addActionListener(this);	 
            bt_perc     .setBounds(230,130,55,30); bt_perc.addActionListener(this);	 
            bt_4        .setBounds(10,160,55,30);  bt_4.addActionListener(this);	 
            bt_5        .setBounds(65,160,55,30);  bt_5.addActionListener(this);	 
            bt_6        .setBounds(120,160,55,30); bt_6.addActionListener(this);	 
            bt_mult     .setBounds(175,160,55,30); bt_mult.addActionListener(this);	 
            bt_umx      .setBounds(230,160,55,30); bt_umx.addActionListener(this);	 
            bt_1        .setBounds(10,190,55,30);  bt_1.addActionListener(this);	 
            bt_2        .setBounds(65,190,55,30);  bt_2.addActionListener(this);	 
            bt_3        .setBounds(120,190,55,30); bt_3.addActionListener(this);	 
            bt_sub      .setBounds(175,190,55,30); bt_sub.addActionListener(this);	 
            bt_zero     .setBounds(10,220,110,30); bt_zero.addActionListener(this);	 
            bt_virgula  .setBounds(120,220,55,30); bt_virgula.addActionListener(this);
            bt_adicao   .setBounds(175,220,55,30); bt_adicao.addActionListener(this);	 
            bt_igual    .setBounds(230,190,55,60); bt_igual.addActionListener(this);	             	    	 
} 

    public static void main(String[] args) {
        JFrame obj_calc = new App();
...
public void retorna_resultado() {  
    if(operacao == 1)
    {	 
    resultado = obj_res.somar(vl_anterior, Double.parseDouble(tf_visor.getText())); 
    tf_historico.setText(tf_historico.getText() + tf_visor.getText()+"=");
    ...
    if(operacao == 2)
    {	 
    resultado = obj_res.subtrair(vl_anterior, Double.parseDouble(tf_visor.getText())); 
    tf_historico.setText(tf_historico.getText() + tf_visor.getText()+"=");
    tf_visor.setText(String.valueOf(resultado));
    tf_historico.setText(tf_historico.getText() +String.valueOf(resultado));
    ...
    if(operacao == 3)
    {	 
    resultado = obj_res.dividir(vl_anterior, Double.parseDouble(tf_visor.getText()));
    tf_historico.setText(tf_historico.getText() + tf_visor.getText()+"=");
    tf_visor.setText(String.valueOf(resultado));
    tf_historico.setText(tf_historico.getText() +String.valueOf(resultado));
    ...
    if(operacao == 4)
    {	 
    resultado = obj_res.multiplicar(vl_anterior, Double.parseDouble(tf_visor.getText())); 
    tf_historico.setText(tf_historico.getText() + tf_visor.getText()+"=");
    tf_visor.setText(String.valueOf(resultado));
    tf_historico.setText(tf_historico.getText() +String.valueOf(resultado));
...
private void setIcon() {
    setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource(name: "calc.png")));    
}
}
